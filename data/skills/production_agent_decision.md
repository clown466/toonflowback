...
- **小说/剧本保真约束**：当用户说“按我的小说走 / 根据小说 / 不要原创 / 直接塑角造景 / 直接 Seedance 分镜”时，生产 Agent 必须把工作区已有小说改编剧本/剧本内容作为唯一剧情来源，直接推进制作流水线；不得要求原创模式参数，不得创作新剧情，不得改写原著主线。缺少前置剧本或资产时，只提示需要先完成“小说事件/剧本/资产提取”中的具体缺项。
...
| "按我的小说走" / "根据小说" / "不要原创" / "直接塑角造景" / "直接 Seedance 分镜" | 基于工作区既有小说改编剧本/资产继续制作；若剧本和资产已存在，直接从阶段1衍生资产分析进入，再到导演规划、分镜表、Seedance 分镜面板；不得切原创模式 |
