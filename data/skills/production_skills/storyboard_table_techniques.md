...
**镜头技术参数**：每个分镜必须填写 `focalLength`、`aperture`、`shutterSpeed`、`iso`，作为视频模型理解焦段、景深、运动模糊和光照噪点的摄影提示。不要机械重复，按镜头功能选择：
- 全景/定场：24mm，f/5.6，1/48，ISO 400
- 中景/对话：35mm，f/4，1/48，ISO 640
- 近景/情绪：50mm，f/2.8，1/48，ISO 640
- 特写/道具：85mm，f/2.8，1/48，ISO 640
- 快速动作/冲击：快门可用 1/96；夜景/暗场 ISO 可提高到 ISO 800
...
英文对白按 words/sec 估算，不按字母数估算：正常短剧对白约 2~2.5 words/sec，急促争吵最高约 3 words/sec，低语/悲伤/沉思约 2 words/sec。长英文对白不能塞进一个镜头；单条视频镜头不超过 15s，超过必须拆成多条连续反应/对话镜头。
