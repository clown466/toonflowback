import{d as P,a4 as F,a5 as H,I as J,c as u,a as o,b as n,ad as V,f as i,w as l,e as m,J as B,aj as T,an as K,ab as f,aa as I,ac as j,z as v,g as G,o as r,_ as O}from"./index-CwV0k4-3.js";import{i as g}from"./axios-CS6M_8N8.js";import{I as Q}from"./index-ClSCDkvg.js";import{I as W}from"./index-DC47Amzq.js";import{B as X}from"./index-BMHyTUml.js";import{T as Y}from"./index-BrId5_IY.js";import{E as Z}from"./index-vv2j4Kxr.js";import{v as ee}from"./MdEditor-CFsxyKNo.js";import{D as te}from"./plugin-B-kKJGYd.js";import"./dialog-Bi5Z-6Df.js";import"./index-mJCZexzi.js";import"./index-DVVM040L.js";import"./index3-DXaXaoa-.js";const ae={class:"imageGenerationSkill"},oe={class:"skillList"},se={class:"toolbar"},ie={class:"listBody"},ne=["onClick"],le={class:"itemTitle"},re={class:"itemMeta"},de={key:0,class:"itemDesc"},ce={class:"editorPanel"},ue={class:"editorHeader"},me={class:"fileControl"},ve={class:"actions"},pe={class:"editorBody"},fe={class:"variableBar"},_e=P({__name:"imageGenerationSkill",setup(ge){const{themeSetting:M}=F(H()),z=["bold","italic","strikeThrough","-","title","unorderedList","orderedList","quote","-","codeRow","code","table","-","revoke","next","=","preview"],D=["{{visualManual}}","{{project.name}}","{{project.artStyle}}","{{project.directorManual}}","{{asset.name}}","{{asset.describe}}","{{asset.prompt}}","{{userRequirement}}"],p=v([]),s=v(""),d=v(""),_=v(""),c=v(L("custom_image_skill")),k=v(!1),N=G(()=>M.value.mode==="dark"?"dark":"light"),$=G(()=>{const t=_.value.trim().toLowerCase();return t?p.value.filter(e=>[e.id,e.name,e.description,e.tags.join(",")].join(" ").toLowerCase().includes(t)):p.value});function U(t){return t==="role"?"角色":t==="scene"?"场景":t==="tool"?"道具":t}function L(t){return`---
id: ${t}
name: 自定义生图 Skill
