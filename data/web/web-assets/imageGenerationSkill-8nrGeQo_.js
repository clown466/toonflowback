import{d as P,a4 as F,a5 as H,I as J,c as u,a as o,b as n,ad as V,f as i,w as l,e as m,J as B,aj as T,an as K,ab as f,aa as I,ac as j,z as v,g as G,o as r,_ as O}from"./index-CcWaFW2J.js";import{i as g}from"./axios-n5VlCZnn.js";import{I as Q}from"./index-3l0r9e0-.js";import{I as W}from"./index-xBf2eNdw.js";import{B as X}from"./index-DjdURnqo.js";import{T as Y}from"./index-DswpgE5v.js";import{E as Z}from"./index-Cefcveil.js";import{v as ee}from"./MdEditor-C23r8Uz3.js";import{D as te}from"./plugin-DQi24oOY.js";import"./dialog-luBO2yFS.js";import"./index-CEZxyaid.js";import"./index-DC-PldJa.js";import"./index3-C_GutCbx.js";const ae={class:"imageGenerationSkill"},oe={class:"skillList"},se={class:"toolbar"},ie={class:"listBody"},ne=["onClick"],le={class:"itemTitle"},re={class:"itemMeta"},de={key:0,class:"itemDesc"},ce={class:"editorPanel"},ue={class:"editorHeader"},me={class:"fileControl"},ve={class:"actions"},pe={class:"editorBody"},fe={class:"variableBar"},_e=P({__name:"imageGenerationSkill",setup(ge){const{themeSetting:M}=F(H()),z=["bold","italic","strikeThrough","-","title","unorderedList","orderedList","quote","-","codeRow","code","table","-","revoke","next","=","preview"],D=["{{visualManual}}","{{project.name}}","{{project.artStyle}}","{{project.directorManual}}","{{asset.name}}","{{asset.describe}}","{{asset.prompt}}","{{userRequirement}}"],p=v([]),s=v(""),d=v(""),_=v(""),c=v(L("custom_image_skill")),k=v(!1),N=G(()=>M.value.mode==="dark"?"dark":"light"),$=G(()=>{const t=_.value.trim().toLowerCase();return t?p.value.filter(e=>[e.id,e.name,e.description,e.tags.join(",")].join(" ").toLowerCase().includes(t)):p.value});function U(t){return t==="role"?"角色":t==="scene"?"场景":t==="tool"?"道具":t}function L(t){return`---
id: ${t}
name: 自定义生图 Skill
