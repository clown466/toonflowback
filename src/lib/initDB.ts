      ...
      initData: async (knex) => {
        await knex("o_agentDeploy").insert([
          ...
          },
          {
            ...
            key: "ttsDubbing",
            name: "TTS配音",
            desc: "根据分镜/视频内容生成角色配音，支持多种声音风格和情绪",
            disabled: true,
          },
          {
            model: "",
            ...
            name: "项目总控Agent:决策层",
            desc: "项目级决策层，负责根据用户意图调用小说、资产、分镜和视频生产工具",
            temperature: 1,
            maxOutputTokens: 0,
            disabled: false,
          },
