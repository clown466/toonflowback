// @routes-hash d9cfdc448ddca4d38ceb4076f2c0818e
...
import route100 from "./routes/projectContext/getBundle";
import route101 from "./routes/projectContext/getConstraints";
import route102 from "./routes/projectContext/inferRoleFactCardFromImage";
import route103 from "./routes/projectContext/listRoleFactCards";
import route104 from "./routes/projectContext/saveConstraints";
import route105 from "./routes/projectContext/saveRoleFactCard";
...
import route132 from "./routes/setting/imageGenerationSkill/delete";
import route133 from "./routes/setting/imageGenerationSkill/get";
import route134 from "./routes/setting/imageGenerationSkill/list";
import route135 from "./routes/setting/imageGenerationSkill/save";
...
import route156 from "./routes/setting/vendorConfig/updateCode";
import route157 from "./routes/setting/vendorConfig/updateVendorInputs";
import route158 from "./routes/setting/vendorConfig/updateVendorName";
import route159 from "./routes/setting/vendorConfig/upVendorModel";
import route160 from "./routes/task/getProject";
import route161 from "./routes/task/getTaskApi";
import route162 from "./routes/task/getTaskCategories";
import route163 from "./routes/task/taskDetails";
import route164 from "./routes/test/test";
...
export default async (app: Express) => {
  ...
  app.use("/api/projectContext/getBundle", route100);
  app.use("/api/projectContext/getConstraints", route101);
  app.use("/api/projectContext/inferRoleFactCardFromImage", route102);
  app.use("/api/projectContext/listRoleFactCards", route103);
  app.use("/api/projectContext/saveConstraints", route104);
  app.use("/api/projectContext/saveRoleFactCard", route105);
  ...
  app.use("/api/setting/imageGenerationSkill/delete", route132);
  app.use("/api/setting/imageGenerationSkill/get", route133);
  app.use("/api/setting/imageGenerationSkill/list", route134);
  app.use("/api/setting/imageGenerationSkill/save", route135);
  ...
  app.use("/api/setting/vendorConfig/updateCode", route156);
  app.use("/api/setting/vendorConfig/updateVendorInputs", route157);
  app.use("/api/setting/vendorConfig/updateVendorName", route158);
  app.use("/api/setting/vendorConfig/upVendorModel", route159);
  app.use("/api/task/getProject", route160);
  app.use("/api/task/getTaskApi", route161);
  app.use("/api/task/getTaskCategories", route162);
  app.use("/api/task/taskDetails", route163);
  app.use("/api/test/test", route164);
}
